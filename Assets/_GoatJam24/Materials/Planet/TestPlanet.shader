...
Shader "TestPlanet"
{
	Properties
	{
		...
		_Power("Power", Range( 0 , 1)) = 0.5081147
		_Scale("Scale", Range( 0 , 20)) = 5.257038
	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float mulTime27 = _TimeParameters.x * 0.003;
				float2 temp_cast_0 = (mulTime27).xx;
				float2 texCoord13 = IN.ase_texcoord8.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D12 = snoise( texCoord13*_Scale );
				simplePerlin2D12 = simplePerlin2D12*0.5 + 0.5;
				float clampResult15 = clamp( simplePerlin2D12 , 0.0 , 1.0 );
				float4 lerpResult21 = lerp( float4( 0,0,0,0 ) , _Color1 , step( clampResult15 , _Power ));
				float4 switchResult29 = (((ase_vface>0)?(lerpResult21):(_Color0)));
				
				float4 switchResult34 = (((ase_vface>0)?(( lerpResult21 * 0.5 )):(( lerpResult21 * 0.3 ))));
				...
				dither30 = step( dither30, ( 1.0 - lerpResult21 ).r );
				clip( 0.0 - dither30);
				

				float3 BaseColor = switchResult29.rgb;
				...
				float Occlusion = 1;
				float Alpha = switchResult34.r;
				float AlphaClipThreshold = dither30;
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float mulTime27 = _TimeParameters.x * 0.003;
				float2 temp_cast_0 = (mulTime27).xx;
				float2 texCoord13 = IN.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D12 = snoise( texCoord13*_Scale );
				simplePerlin2D12 = simplePerlin2D12*0.5 + 0.5;
				float clampResult15 = clamp( simplePerlin2D12 , 0.0 , 1.0 );
				float4 lerpResult21 = lerp( float4( 0,0,0,0 ) , _Color1 , step( clampResult15 , _Power ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float mulTime27 = _TimeParameters.x * 0.003;
				float2 temp_cast_0 = (mulTime27).xx;
				float2 texCoord13 = IN.ase_texcoord4.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D12 = snoise( texCoord13*_Scale );
				simplePerlin2D12 = simplePerlin2D12*0.5 + 0.5;
				float clampResult15 = clamp( simplePerlin2D12 , 0.0 , 1.0 );
				float4 lerpResult21 = lerp( float4( 0,0,0,0 ) , _Color1 , step( clampResult15 , _Power ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float mulTime27 = _TimeParameters.x * 0.003;
				float2 temp_cast_0 = (mulTime27).xx;
				float2 texCoord13 = IN.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D12 = snoise( texCoord13*_Scale );
				simplePerlin2D12 = simplePerlin2D12*0.5 + 0.5;
				float clampResult15 = clamp( simplePerlin2D12 , 0.0 , 1.0 );
				float4 lerpResult21 = lerp( float4( 0,0,0,0 ) , _Color1 , step( clampResult15 , _Power ));
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float mulTime27 = _TimeParameters.x * 0.003;
				float2 temp_cast_0 = (mulTime27).xx;
				float2 texCoord13 = IN.ase_texcoord5.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D12 = snoise( texCoord13*_Scale );
				simplePerlin2D12 = simplePerlin2D12*0.5 + 0.5;
				float clampResult15 = clamp( simplePerlin2D12 , 0.0 , 1.0 );
				float4 lerpResult21 = lerp( float4( 0,0,0,0 ) , _Color1 , step( clampResult15 , _Power ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				float mulTime27 = _TimeParameters.x * 0.003;
				float2 temp_cast_0 = (mulTime27).xx;
				float2 texCoord13 = IN.ase_texcoord.xy * float2( 1,1 ) + temp_cast_0;
				float simplePerlin2D12 = snoise( texCoord13*_Scale );
				simplePerlin2D12 = simplePerlin2D12*0.5 + 0.5;
				float clampResult15 = clamp( simplePerlin2D12 , 0.0 , 1.0 );
				float4 lerpResult21 = lerp( float4( 0,0,0,0 ) , _Color1 , step( clampResult15 , _Power ));
				...
				surfaceDescription.Alpha = switchResult34.r;
				surfaceDescription.AlphaClipThreshold = dither30;
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1344.654,-99.98289;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-1343.02,98.11346;Inherit;False;Property;_Scale;Scale;1;0;Create;True;0;0;0;False;0;False;5.257038;0;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;23;-396.3204,-277.1867;Inherit;False;Property;_Color1;Color 1;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;27;-1590.607,-79.22084;Inherit;False;1;0;FLOAT;0.003;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;22;-2.929175,-435.3176;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;21;-99.21711,-167.4304;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClipNode;32;442.6061,309.0553;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DitheringNode;30;245.9883,322.5552;Inherit;False;0;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;33;83.80105,320.5598;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-743.7397,169.0258;Inherit;False;Property;_Power;Power;0;0;Create;True;0;0;0;False;0;False;0.5081147;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;18;-397.0203,-92.88654;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.36;False;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;12;-991.0543,-96.08296;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;9.4;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;15;-679.249,-76.45325;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;921.9014,-143.744;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;TestPlanet;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;40;Workflow;1;0;Surface;1;638509829734897591;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;638509831376671476;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;638509832523262566;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SwitchByFaceNode;29;471.9538,-247.0633;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SwitchByFaceNode;34;610.8427,-89.21612;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;392.4926,49.67326;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;398.9429,-90.51615;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;26;185.2911,145.239;Inherit;False;Constant;_Float0;Float 0;4;0;Create;True;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;190.9428,-4.716153;Inherit;False;Constant;_Float1;Float 0;4;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E055D40D0C93927CBE800456F6993F81D6F44523