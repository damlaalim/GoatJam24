	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float mulTime24 = _TimeParameters.x * _Hue;
				float3 hsvTorgb16 = HSVToRGB( float3(( hsvTorgb17.x + mulTime24 ),hsvTorgb17.y,hsvTorgb17.z) );
...
Node;AmplifyShaderEditor.SimpleTimeNode;24;-160.7024,201.74;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=B9E3849A812F0D0564976F62C1F4EF8578FE1DF3